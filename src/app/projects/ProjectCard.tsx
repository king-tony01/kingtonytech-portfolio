...
export default function ProjectCard({ project }: { project: ProjectProps }) {
  // Extract domain for WhatsApp style preview
  let domain = "";
  if (project.liveUrl) {
    try {
      ...
      <div className={styles.visualBox}>
        {project.imageUrl ? (
          <Image 
            ...
            unoptimized={project.imageUrl.includes("image.thum.io") || project.imageUrl.includes("s0.wp.com")} 
          />
        ) : (
        ...
        <div className={styles.textGroup}>
          <div className={styles.titleWrapper}>
            ...
            <div className={styles.titleStack}>
              ...
              {domain && <span className={styles.projectDomain}>{domain}</span>}
            </div>
          </div>
