...
export const alt = "KingTony Technologies";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      <div
        style={{
          ...
          backgroundImage: "linear-gradient(to bottom right, #020604, rgba(16, 185, 129, 0.2), #020604)",
      ...
      >
        ...
        >
          kingtonytech-portfolio.vercel.app
        </div>
      </div>
    ),
    {
